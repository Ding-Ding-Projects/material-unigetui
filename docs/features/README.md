...
| Category | Covers |
| --- | --- |
| [Package management](package-management/) | Drivers, discovery, the operations queue |
...
`pending` with the reason — the inventory is the index of what is missing, and
this directory is the index of what is written.
