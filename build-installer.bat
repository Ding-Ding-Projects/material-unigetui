@echo off
REM Obtains every dependency, builds, then produces the unsigned Squirrel.Windows installer.
REM
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0script/build-windows.ps1" -Mode Installer %SILENT_FLAG%
exit /b %ERRORLEVEL%
