@echo off
REM Obtains every dependency this project needs, then builds a runnable application.
REM
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0script/build-windows.ps1" -Mode Build %SILENT_FLAG%
exit /b %ERRORLEVEL%
